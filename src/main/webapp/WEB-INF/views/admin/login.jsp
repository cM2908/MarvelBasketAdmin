		...
		<div class="card">
			<div class="card-body login-card-body">
				<p class="login-box-msg">Admin Login</p>
			  	<sf:form action="/admin/authenticate" modelAttribute="loginCommand">
				    <div class="input-group mb-3">
				    	<sf:input path="email" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control" placeholder="Email" required="required"/>
				    ...
				    <div class="row">
				    	<div class="col-4">
				      	...
				      	<div class="col-8">
				        	<a href="/admin/fpform" class="float-right">Forgot Password ?</a>
						</div>
				    </div>
				</sf:form>
			</div>
