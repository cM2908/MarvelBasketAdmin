...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
		...
		<div class="content-wrapper">
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
			        	<div class="col-sm-6">
			            <h3 class="m-0">Approved Sellers</h3>
			          	</div>
			          	<div class="col-sm-6">
			                ...
			                <tbody>
			                	<myTag:forEach var="i" items="${sellerList}">
									<tr>
										...
										<myTag:if test="${i.sellerStatus == APPROVED}">
											<td><span class="badge bg-success">APPROVED</span></td>
										</myTag:if>
										<myTag:if test="${i.sellerStatus == STOPPED}">
											<td><span class="badge bg-danger">STOPPED</span></td>
										</myTag:if>
										<td>${i.shopName}</td>
										<td><center><a href="/sellerdetails/${i.sellerId}" class="btn btn-info" style="padding:3px 15px 3px 15px;">More</a></center></td>
										<td><center><a href="/sellerproducts/${i.sellerId}" class="btn btn-success" style="padding:3px 15px 3px 15px;">Products</a></center></td>
				                	</tr>
				                </myTag:forEach>
			                </tbody>
						</table>
	...
	<script type="text/javascript">
		    $(document).ready(function() {
			    var c = "${accountRejectSuccess}";
			    var d = "${accountApproveSuccess}";
			    toastr.options = {
				    		  "closeButton": true,
				    		  "debug": true,
				    		  "newestOnTop": false,
